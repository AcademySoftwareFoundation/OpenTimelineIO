...
def build_burnins(input_otio):
    ...
    :rtype: [extern_ffmpeg_burnins.Burnins(), ...]
    """

    if os.path.dirname(__file__) not in sys.path:
        sys.path.append(os.path.dirname(__file__))

    import extern_ffmpeg_burnins
    key = 'ffmpeg_burnins'
    ...
    for clip in input_otio.each_clip():
        ...
        burnins.append(extern_ffmpeg_burnins.Burnins(media,
                                                     streams=streams))
