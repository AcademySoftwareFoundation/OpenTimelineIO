...
subprocess.call('cd ../doxygen; doxygen config/dox_config', shell=True)
...
latex_documents = [
    ('index', '{}.tex'.format(PACKAGE_NAME),
     u'{} Documentation'.format(PACKAGE_TITLE),
     AUTHOR_NAME, 'manual'),
]
...
man_pages = [
    ('index', PACKAGE_NAME, u'{} Documentation'.format({PACKAGE_TITLE}),
     [AUTHOR_NAME], 1)
]
...
texinfo_documents = [
    ('index', PACKAGE_NAME, u'{} Documentation'.format(PACKAGE_TITLE),
     AUTHOR_NAME, PACKAGE_TITLE, 'One line description of project.',
     'Miscellaneous'),
]
