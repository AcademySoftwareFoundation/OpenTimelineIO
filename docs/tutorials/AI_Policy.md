...
- [OpenImageIO AI Tool Policy](https://github.com/AcademySoftwareFoundation/OpenImageIO/blob/main/docs/dev/AI_Policy.md) -- we directly forked this as our starting point.
