...
*module*: opentimelineio.adapters.adapter.Adapter

*documentation*: Adapters convert between OTIO and other formats.
...
*module*: opentimelineio.core.composable.Composable

*documentation*: An object that can be composed by tracks.
...
*module*: opentimelineio.core.composition.Composition

*documentation*: Base class for an OTIO Item that contains other Items.
...
*module*: opentimelineio.core.item.Item

*documentation*: An Item is a Composable that can be part of a Composition or Timeline.
...
*module*: opentimelineio.core.media_reference.MediaReference

*documentation*: Base Media Reference Class.
...
*module*: opentimelineio.hooks.HookScript
...
*module*: opentimelineio.media_linker.MediaLinker
...
*module*: opentimelineio.plugins.manifest.Manifest

*documentation*: Defines an OTIO plugin Manifest.
...
*module*: opentimelineio.plugins.python_plugin.PythonPlugin

*documentation*: A class of plugin that is encoded in a python module, exposed via a
    manifest.
...
*module*: opentimelineio.schema.clip.Clip

*documentation*: The base editable object in OTIO.
...
*module*: opentimelineio.schema.effect.Effect
...
*module*: opentimelineio.schema.effect.TimeEffect

*documentation*: Base Time Effect Class
...
*module*: opentimelineio.schema.effect.LinearTimeWarp

*documentation*: A time warp that applies a linear scale across the entire clip
...
*module*: opentimelineio.schema.effect.FreezeFrame

*documentation*: Hold the first frame of the clip for the duration of the clip.
...
*module*: opentimelineio.schema.external_reference.ExternalReference

*documentation*: Reference to media via a url, for example "file:///var/tmp/foo.mov" 
...
*module*: opentimelineio.schema.gap.Gap
...
*module*: opentimelineio.schema.generator_reference.GeneratorReference
...
*module*: opentimelineio.schema.marker.Marker

*documentation*:  Holds metadata over time on a timeline 
...
*module*: opentimelineio.schema.missing_reference.MissingReference

*documentation*: Represents media for which a concrete reference is missing.
...
*module*: opentimelineio.schema.schemadef.SchemaDef
...
*module*: opentimelineio.schema.serializable_collection.SerializableCollection

*documentation*: A kind of composition which can hold any serializable object.
...
*module*: opentimelineio.schema.stack.Stack
...
*module*: opentimelineio.schema.timeline.Timeline
...
*module*: opentimelineio.schema.track.Track
...
*module*: opentimelineio.schema.transition.Transition

*documentation*: Represents a transition between two items.
