...
C++ Example (can be viewed/run in `examples/upgrade_example.cpp`):
...
C++ Example, building off the prior section SimpleClass example (can be viewed/run in `examples/upgrade_example.cpp`):
