...
This document is automatically generated by running
 docs/autogen_serialized_datamodel.py, or by running `make md_with_helpstrings-model`.  It is
 part of the unit tests suite and should be updated whenever the schema changes.
 If it needs to be updated, run: `make md_with_helpstrings-model-update` and this file should be
 regenerated.
...
def _write_documentation(model):
    ...
    return md_with_helpstrings.getvalue()
