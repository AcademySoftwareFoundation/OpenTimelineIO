...
public:
    ...
    static RationalTime from_timecode(std::string const& timecode, double rate, std::string *err_msg);
    static RationalTime from_time_string(std::string const& time_string, double rate, std::string *err_msg);
    ...
    std::string to_timecode(std::string *err_msg) const {
        return to_timecode(_rate, err_msg);
    }
