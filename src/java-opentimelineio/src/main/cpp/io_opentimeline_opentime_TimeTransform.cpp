...
JNIEXPORT jdoubleArray JNICALL Java_io_opentimeline_opentime_TimeTransform_appliedToTimeRangeNative
        (JNIEnv *env, jclass thisClass, jdoubleArray timeTransform, jdoubleArray timeRange) {
...
JNIEXPORT jdoubleArray JNICALL Java_io_opentimeline_opentime_TimeTransform_appliedToTimeTransformNative
        (JNIEnv *env, jclass thisClass, jdoubleArray timeTransform, jdoubleArray otherTimeTransform) {
    opentime::TimeTransform tt = timeTransformFromArray(env, timeTransform);
    opentime::TimeTransform otherTt = timeTransformFromArray(env, otherTimeTransform);
...
JNIEXPORT jdoubleArray JNICALL Java_io_opentimeline_opentime_TimeTransform_appliedToRationalTimeNative
        (JNIEnv *env, jclass thisClass, jdoubleArray timeTransform, jdoubleArray rationalTime) {
    opentime::TimeTransform tt = timeTransformFromArray(env, timeTransform);
