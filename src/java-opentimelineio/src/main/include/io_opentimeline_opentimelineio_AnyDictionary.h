 ...
 */
JNIEXPORT jboolean JNICALL Java_io_opentimeline_opentimelineio_AnyDictionary_containsKeyNative
 ...
 */
JNIEXPORT jobject JNICALL Java_io_opentimeline_opentimelineio_AnyDictionary_getNative
  (JNIEnv *, jobject, jstring);
 ...
 */
JNIEXPORT jobject JNICALL Java_io_opentimeline_opentimelineio_AnyDictionary_putNative
 ...
 * Signature: (Ljava/lang/String;Lio/opentimeline/opentimelineio/Any;)Lio/opentimeline/opentimelineio/Any;
 */
JNIEXPORT jobject JNICALL Java_io_opentimeline_opentimelineio_AnyDictionary_replaceNative
  (JNIEnv *, jobject, jstring, jobject);
