...
ErrorStatus::outcome_to_string(Outcome o)
{
    switch(o)
    {
        ...
        case INVALID_TIMECODE_RATE: return "invalid timecode rate";
        case NON_DROPFRAME_RATE: return "rate is not a dropframe rate";
        ...
        case NEGATIVE_VALUE: return "value cannot be negative here";
