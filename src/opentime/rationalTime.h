...
public:
    ...
    {
        if(std::isnan(_rate) || std::isnan(_value)) { return true; }
    ...
    static RationalTime duration_from_start_end_time_inclusive(
...
private:
    ...
    RationalTime _floor() const { return RationalTime{ floor(_value), _rate }; }
