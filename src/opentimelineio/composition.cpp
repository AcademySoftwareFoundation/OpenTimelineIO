...
Composition::handles_of_child(Composable const*, ErrorStatus*) const {
...
TimeRange Composition::range_of_child_at_index(int, ErrorStatus* error_status) const {
    *error_status = ErrorStatus::NOT_IMPLEMENTED;
    return TimeRange();
}

TimeRange Composition::trimmed_range_of_child_at_index(int, ErrorStatus* error_status) const {
    *error_status = ErrorStatus::NOT_IMPLEMENTED;
    return TimeRange();
}
