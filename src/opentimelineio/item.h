...
public:
    ...
    optional<TimeRange> const& source_range() const { return _source_range; }
    ...
    std::vector<Retainer<Effect>>& effects() { return _effects; }

    std::vector<Retainer<Effect>> const& effects() const { return _effects; }

    std::vector<Retainer<Marker>>& markers() { return _markers; }

    std::vector<Retainer<Marker>> const& markers() const { return _markers; }
    ...
    optional<TimeRange>
    trimmed_range_in_parent(ErrorStatus* error_status) const;
