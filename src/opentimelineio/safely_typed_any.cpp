...
any create_safely_typed_any(int&& value) {
    return any(value);
}

any create_safely_typed_any(int64_t&& value) {
    return any(value);
}
...
any create_safely_typed_any(RationalTime&& value) {
    return any(value);
}

any create_safely_typed_any(TimeRange&& value) {
    return any(value);
}
...
any create_safely_typed_any(SerializableObject* value) {
