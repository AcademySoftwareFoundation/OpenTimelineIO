...
_simple_any_comparison<char const*>(std::any const& lhs, std::any const& rhs)
{
    return lhs.type() == typeid(char const*)
           ...
           && !strcmp(std::any_cast<char const*>(lhs), std::any_cast<char const*>(rhs));
}
...
SerializableObject::Writer::_build_dispatch_tables()
{
    ...
    wt[&typeid(void)] = [this](std::any const&) { _encoder.write_null_value(); };
...
bool
SerializableObject::Writer::_any_dict_equals(std::any const& lhs, std::any const& rhs)
{
...
bool
SerializableObject::Writer::_any_array_equals(std::any const& lhs, std::any const& rhs)
{
...
bool
SerializableObject::Writer::_any_equals(std::any const& lhs, std::any const& rhs)
{
