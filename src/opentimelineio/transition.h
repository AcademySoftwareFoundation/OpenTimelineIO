...
public:
    ...
    std::string transition_type() const { return _transition_type; }
    ...
    RationalTime in_offset() const { return _in_offset; }

    void set_in_offset(RationalTime in_offset) { _in_offset = in_offset; }

    RationalTime out_offset() const { return _out_offset; }

    void set_out_offset(RationalTime out_offset) { _out_offset = out_offset; }
