...
CLASS
_type_checked(py::object const& rhs, char const* op)
{
    try
    {
    ...
    {
        std::string rhs_type =
            py::cast<std::string>(rhs.get_type().attr("__name__"));
...
define_imath_2d(py::module m)
{
    ...
    py::class_<IMATH_NAMESPACE::V2d>(m, "V2d", py::module_local())
        ...
        .def(
            "__getitem__",
            [](IMATH_NAMESPACE::V2d const& v, size_t i) { return v[i]; })
        .def(
            "__eq__",
            [](IMATH_NAMESPACE::V2d lhs, py::object const& rhs) {
        ...
        .def(
            "__iadd__",
            [](IMATH_NAMESPACE::V2d lhs, IMATH_NAMESPACE::V2d rhs) {
                return lhs += rhs;
            })
        .def(
            "__isub__",
        ...
        .def(
            "equalWithAbsError",
            [](IMATH_NAMESPACE::V2d*       v,
               IMATH_NAMESPACE::V2d const& v2,
               double e) { return v->equalWithAbsError(v2, e); })
        .def(
            "equalWithRelError",
            [](IMATH_NAMESPACE::V2d*       v,
               IMATH_NAMESPACE::V2d const& v2,
               double e) { return v->equalWithRelError(v2, e); })
        .def(
            "dot",
    ...
    py::class_<IMATH_NAMESPACE::Box2d>(m, "Box2d", py::module_local())
        .def(py::init<>([]() {
            return IMATH_NAMESPACE::Box2d(IMATH_NAMESPACE::V2d(0.0, 0.0));
        }))
        ...
        .def(
            "__eq__",
            [](IMATH_NAMESPACE::Box2d lhs, py::object const& rhs) {
        ...
        .def(
            "extendBy",
            [](IMATH_NAMESPACE::Box2d* box, IMATH_NAMESPACE::V2d const& point) {
                return box->extendBy(point);
            })
        .def(
            "extendBy",
            [](IMATH_NAMESPACE::Box2d* box, IMATH_NAMESPACE::Box2d const& rhs) {
...
void
otio_imath_bindings(py::module m)
{
    define_imath_2d(m);
}
