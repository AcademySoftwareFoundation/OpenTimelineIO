...
template <typename T>
std::vector<T*>
vector_or_default(std::optional<std::vector<T*>> item)
{
    if (item.has_value())
    {
        return item.value();
    ...
    std::vector<SerializableObject*>& l)
{
    ...
    {
        for (const auto& child: t->template find_children<U>(
                 ErrorStatusHandler(),
                 search_range,
                 shallow_search))
        {
    ...
    bool                            shallow_search = false)
{
    ...
    if (find_children<T, Clip>(
            ...
            l))
        ;
    else if (find_children<T, Composition>(
                 t,
                 descended_from_type,
                 search_range,
                 shallow_search,
        ...
        ;
                 ...
                 l))
        ;
    else if (find_children<T, Timeline>(
                 t,
                 descended_from_type,
                 search_range,
                 shallow_search,
        ...
        ;
                 ...
                 l))
        ;
    else if (find_children<T, Transition>(
                 t,
                 descended_from_type,
                 search_range,
                 shallow_search,
    ...
    {
        for (const auto& child: t->template find_children<Composable>(
                 ErrorStatusHandler(),
                 search_range,
                 shallow_search))
        {
    ...
    bool                            shallow_search = false)
{
    std::vector<SerializableObject*> l;
    for (const auto& clip:
         t->find_clips(ErrorStatusHandler(), search_range, shallow_search))
    {
...
define_bases1(py::module m)
{
    py::class_<SerializableObject, managing_ptr<SerializableObject>>(
        ...
        .def_property_readonly(
            "is_unknown_schema",
            &SerializableObject::is_unknown_schema);
...
define_bases2(py::module m)
{
    ...
    py::class_<Color>(
        ...
        .def_property_readonly_static(
            "PINK",
            [](py::object) { return new Color(Color::pink); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "RED",
            [](py::object) { return new Color(Color::red); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "ORANGE",
            [](py::object) { return new Color(Color::orange); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "YELLOW",
            [](py::object) { return new Color(Color::yellow); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "GREEN",
            [](py::object) { return new Color(Color::green); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "CYAN",
            [](py::object) { return new Color(Color::cyan); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "BLUE",
            [](py::object) { return new Color(Color::blue); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "PURPLE",
            [](py::object) { return new Color(Color::purple); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "MAGENTA",
            [](py::object) { return new Color(Color::magenta); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "BLACK",
            [](py::object) { return new Color(Color::black); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "WHITE",
            [](py::object) { return new Color(Color::white); },
            py::return_value_policy::take_ownership)
        .def_property_readonly_static(
            "TRANSPARENT",
            [](py::object) { return new Color(Color::transparent); },
            py::return_value_policy::take_ownership);
        ...
        .def(
            py::init(
                [](std::string const&                              name,
                   std::optional<std::vector<SerializableObject*>> children,
                   py::object                                      metadata) {
...
Other effects are handled by the :class:`Effect` class.
    ...
    auto clip_class =
        py::class_<Clip, Item, managing_ptr<Clip>>(
            m,
            "Clip",
            py::dynamic_attr(),
            R"docstring(
...
Contains a :class:`.MediaReference` and a trim on that media reference.
            ...
            .def(
                ...
                "effects"_a = py::none(),
                "markers"_a = py::none(),
                "active_media_reference"_a =
                    std::string(Clip::default_media_key),
                "color"_a = std::nullopt)
            .def_property_readonly_static(
                "DEFAULT_MEDIA_KEY",
                [](py::object /* self */) { return Clip::default_media_key; })
            .def_property(
                "media_reference",
...
Should be subclassed (for example by :class:`.Track` and :class:`.Stack`), not used directly.
        ...
        .def(
            py::init([](std::string                             name,
                ...
                Composition* c = new Composition(
                    ...
                    py_to_any_dictionary(metadata));
                c->set_children(
                    vector_or_default<Composable>(children),
                    ErrorStatusHandler());
                return c;
            }),
            py::arg_v("name"_a = std::string()),
    ...
    py::class_<Track::Kind>(track_class, "Kind")
        .def_property_readonly_static(
            "Audio",
            [](py::object /* self */) { return Track::Kind::audio; })
        .def_property_readonly_static("Video", [](py::object /* self */) {
    ...
    py::class_<MediaReference, SOWithMetadata, managing_ptr<MediaReference>>(
        ...
        .def(
            py::init([](std::string              name,
                        ...
                        py::object               metadata,
                        std::optional<IMATH_NAMESPACE::Box2d> const&
...
- ``file:///show/sequence/shot/sample_image_sequence.0001.exr``
    ...
    py::enum_<ImageSequenceReference::MissingFramePolicy>(
        ...
        .value(
            ...
            "Application should stop and raise an error.")
        .value(
            "hold",
