...
bool
compare_typeids(std::type_info const& lhs, std::type_info const& rhs)
{
    return lhs.name() == rhs.name() || !strcmp(lhs.name(), rhs.name());
}

static std::
    map<std::type_info const*, std::function<py::object(std::any const&, bool)>>
        _py_cast_dispatch_table;
static std::map<std::string, std::function<py::object(std::any const&, bool)>>
    _py_cast_dispatch_table_by_name;

py::object
plain_string(std::string const& s)
{
...
_build_any_to_py_dispatch_table()
{
    ...
    t[&typeid(bool)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_bool_any(a));
    };
    t[&typeid(int)] = [](std::any const& a, bool) {
        return plain_int(safely_cast_int_any(a));
    };
    t[&typeid(int64_t)] = [](std::any const& a, bool) {
        return plain_int(safely_cast_int64_any(a));
    };
    t[&typeid(uint64_t)] = [](std::any const& a, bool) {
        return plain_uint(safely_cast_uint64_any(a));
    };
    t[&typeid(double)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_double_any(a));
    };
    t[&typeid(std::string)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_string_any(a));
    };
    t[&typeid(RationalTime)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_rational_time_any(a));
    };
    t[&typeid(TimeRange)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_time_range_any(a));
    };
    t[&typeid(TimeTransform)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_time_transform_any(a));
    };
    t[&typeid(Color)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_color_any(a));
    };
    t[&typeid(IMATH_NAMESPACE::V2d)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_point_any(a));
    };
    t[&typeid(IMATH_NAMESPACE::Box2d)] = [](std::any const& a, bool) {
        return py::cast(safely_cast_box_any(a));
    };
    ...
    t[&typeid(AnyDictionaryProxy*)] = [](std::any const& a, bool) {
        return py::cast(std::any_cast<AnyDictionaryProxy*>(a));
    };
    t[&typeid(AnyVectorProxy*)] = [](std::any const& a, bool) {
        return py::cast(std::any_cast<AnyVectorProxy*>(a));
    };
...
static void
py_to_any(py::object const& o, std::any* result)
{
...
AnyDictionary
py_to_any_dictionary(py::object const& o)
{
    if (o.is_none())
    {
    ...
    {
        throw py::type_error(string_printf(
            "Expected an AnyDictionary (i.e. metadata); got %s instead",
...
py::object
any_to_py(std::any const& a, bool top_level)
{
...
struct KeepaliveMonitor
{
    ...
    void monitor()
    {
        ...
        else
        {
            ...
            {
                _keep_alive =
                    pybind11::object(); // this could cause destruction
            }
        }
    }
};
